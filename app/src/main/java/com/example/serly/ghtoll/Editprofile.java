...
public class Editprofile extends AppCompatActivity {
    private TextInputLayout Userfirstnameprofile, Useremailprofile, UserphoneNumberprofile, UserOccupationprofile, UserAboutprofile, UserLastnameProfile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Userfirstnameprofile = findViewById(R.id.Txtprofilefirstname);
        UserLastnameProfile = findViewById(R.id.TxtprofileLastname);
        ...
        // action when one click on save profile
        ...
        mStorageReference = FirebaseStorage.getInstance().getReference("userPhotos1");
    ...
    private void Saveuserdetails() {
        ...
        String ufirstname = Userfirstnameprofile.getEditText().getText().toString();
        String ulastname = UserLastnameProfile.getEditText().getText().toString();
        ...
        if (ufirstname.isEmpty() || ulastname.isEmpty() || unumber.isEmpty() || uoccupation.isEmpty() || uabout.isEmpty()) {
            Toast.makeText(this, "Please fill all fields", Toast.LENGTH_LONG).show();
            return;
        }

        String fullName = ufirstname + " " + ulastname;
        ...
        userDbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Userfirstnameprofile.getEditText().setText(showFirstName);
                    UserLastnameProfile.getEditText().setText(showLastName);
